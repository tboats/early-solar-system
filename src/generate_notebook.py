...
def create_notebook():
    ...
    # Cell 5: Run Solar System Preset
    add_markdown("## 2. Solar System-like Simulation Analysis")
    add_code([
        "data_ss = load_simulation_data('solar_system')\n",
        "analyze_preset(data_ss, 'Solar System Preset')\n"
    ])

    # Cell 6: Run Hot Jupiter Preset
    add_markdown("## 3. Hot Jupiter-like Simulation Analysis")
    add_code([
        "data_hj = load_simulation_data('hot_jupiter')\n",
        "analyze_preset(data_hj, 'Hot Jupiter Preset')\n"
    ])

    # Cell 7: Disk Clearing Analysis
    add_markdown([
    ...
    # Cell 8: Radial Mass Distribution Analysis
    add_markdown([
    ...
    # Cell 9: Resonance Analysis and Captures over Time
    add_markdown([
    ...
    # Save to file
    dest_path = os.path.join(os.path.dirname(__file__), "..", "analysis.ipynb")
    dest_path = os.path.abspath(dest_path)
    
    with open(dest_path, "w") as f:
        json.dump(notebook, f, indent=2)
    print(f"✅ Generated Jupyter Notebook: {dest_path}")
